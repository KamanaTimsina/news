...
import Breakingdetails from '../Breakingpost/Breakingdetails';
...
function Breaking() {
  ...
  const articles = [
    ...
    {
      id: 5,
      title: 'Family destination for 2024',
      date: 'June 25, 2024',
      image: Destination,
      link: '/article/5'
    },
    {
      id: 6,
      title: 'Immersive Experiences: What to Expect',
      date: 'June 25, 2024',
      image: Immersive,
      link: '/article/6'
    },
    {
      id: 7,
      title: 'Work Smart: Tech for Remote Success',
      date: 'June 25, 2024',
      image: Computer,
      link: '/article/7'
    }
  ...
  const ArticleCard = ({ article }) => (
    <div className="p-2">
      <Link to={"/Breakingpost"} onClick={handleClick}>
        <div className="bg-white shadow-md rounded-md overflow-hidden flex flex-col sm:flex-row items-start gap-4 p-4 h-full cursor-pointer hover:shadow-lg transition">
